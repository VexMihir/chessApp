...
class chessUtils {
    ...
    static isKingSafe(board,
        ...
        if (upBlock !== 9) {
            ...
            if (currentKingPieceLocation[0] !== this.getPieceSymbolByCoords(board, upBlockCoordLocation)[0]) {
                return false
            }
        }
        ...
        if (downBlock !== 0) {
            if (currentKingPieceLocation[0] !== this.getPieceSymbolByCoords(board, downBlockCoordLocation)[0]) {
                return false
            }
        }
        ...
        if (rightBlock !== 9) {
            if (currentKingPieceLocation[0] !== this.getPieceSymbolByCoords(board, rightBlockCoordLocation)[0]) {
                return false
            }
        }
        ...
        if (leftBlock !== 0) {
            if (currentKingPieceLocation[0] !== this.getPieceSymbolByCoords(board, leftBlockCoordLocation)[0]) {
                return false
            }
        }
        ...
        && upRightBlock !== 9 && downLeftBlock !== 0) {
            if (currentKingPieceLocation[0] !== this.getPieceSymbolByCoords(board, upRightCoordLocation)[0] 
            || currentKingPieceLocation[0] !== this.getPieceSymbolByCoords(board, downLeftCoordLocation[0])) {
                return false
            }
        }
        ...
        && upLeftBlock !== 9 && downRightBlock !== 0) {
            if (currentKingPieceLocation[0] !== this.getPieceSymbolByCoords(board, upLeftCoordLocation)[0] 
            || currentKingPieceLocation[0] !== this.getPieceSymbolByCoords(board, downRightCoordLocation[0])) {
                return false
            }
        }
        ...
        let knightOneOClockLocation = this.getCoordsByRowCol(8 - currentKingPieceLocation[1] + 2, row.findIndex((e) => e === currentKingPieceLocation[0]) + 1);
        let knightTwoOClockLocation = this.getCoordsByRowCol(8 - currentKingPieceLocation[1] + 1, row.findIndex((e) => e === currentKingPieceLocation[0]) + 2);
        let knightFourOClockLocation = this.getCoordsByRowCol(8 - currentKingPieceLocation[1] - 1, row.findIndex((e) => e === currentKingPieceLocation[0]) + 2);
        let knightFiveOClockLocation = this.getCoordsByRowCol(8 - currentKingPieceLocation[1] - 2, row.findIndex((e) => e === currentKingPieceLocation[0]) + 1);
        let knightSevenOClockLocation = this.getCoordsByRowCol(8 - currentKingPieceLocation[1] - 2, row.findIndex((e) => e === currentKingPieceLocation[0]) - 1);;
        let knightEightOClockLocation = this.getCoordsByRowCol(8 - currentKingPieceLocation[1] - 1, row.findIndex((e) => e === currentKingPieceLocation[0]) - 2);
        let knightTenOClockLocation = this.getCoordsByRowCol(8 - currentKingPieceLocation[1] + 1, row.findIndex((e) => e === currentKingPieceLocation[0]) - 2);;
        let knightElevenOClockLocation = this.getCoordsByRowCol(8 - currentKingPieceLocation[1] + 2, row.findIndex((e) => e === currentKingPieceLocation[0]) - 1);

        if (knightOneOClockLocation !== null && currentKingPieceLocation[0] !== this.getPieceSymbolByCoords(board, knightOneOClockLocation)[0]) {
            return false
        }

        if (knightTwoOClockLocation !== null && currentKingPieceLocation[0] !== this.getPieceSymbolByCoords(board, knightTwoOClockLocation)[0]) {
            return false
        }

        if (knightFourOClockLocation !== null && currentKingPieceLocation[0] !== this.getPieceSymbolByCoords(board, knightFourOClockLocation)[0]) {
            return false
        }

        if (knightFiveOClockLocation !== null && currentKingPieceLocation[0] !== this.getPieceSymbolByCoords(board, knightFiveOClockLocation)[0]) {
            return false
        }

        if (knightSevenOClockLocation !== null && currentKingPieceLocation[0] !== this.getPieceSymbolByCoords(board, knightSevenOClockLocation)[0]) {
            return false
        }

        if (knightEightOClockLocation !== null && currentKingPieceLocation[0] !== this.getPieceSymbolByCoords(board, knightEightOClockLocation)[0]) {
            return false
        }

        if (knightTenOClockLocation !== null && currentKingPieceLocation[0] !== this.getPieceSymbolByCoords(board, knightTenOClockLocation)[0]) {
            return false
        }

        if (knightElevenOClockLocation !== null && currentKingPieceLocation[0] !== this.getPieceSymbolByCoords(board, knightElevenOClockLocation)[0]) {
            return false
        }
    ...
    // // determine if a chessboard is in stalemate
    // // if one of player cannot move, it is not in stalemate

    // // Determine if a white player can move
    // static canWhitePlayerMove() {

    // }

    // // Determined if a black player can move
    // static canBlackPlayerMove() {
