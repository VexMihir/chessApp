...
export default function Register() {
    ...
    async function handleSubmit(e) {
        ...
        if (confrimPassword !== password) {
            ...
            try {
                // const response = await fetch('http://localhost:5001/register' || "https://chessbackend-evhq.onrender.com/register" , requestOptions)
                const response = await fetch("https://chessbackend-evhq.onrender.com/register" , requestOptions)
