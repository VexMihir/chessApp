    ...
    <>
      ...
      <div className="chessApp__page chessApp__page_theme">
        ...
        <div className="chessApp__main ">
          ...
          <Sideboard type="inGame" setIsGameStarted={setIsGameStarted} isModalOpen={isModalOpen} setIsModalOpen={setIsModalOpen} setResult={setResult} activePlayer={activePlayer}/>
        </div>
      </div>
    </>
  );
