export function InGamePrevMovePannel({history}) {
    ...
    return history === undefined ? (
        <div
            ...
            className="overflow-y-scroll text-black bg-white grid grid-cols-[1fr_6fr_6fr] text-2xl text-center"
        ></div>
    ) : (
        <div
            className="overflow-y-scroll text-black bg-white grid grid-cols-[1fr_6fr_6fr] grid-rows-[repeat(9,24.5px)] text-2xl text-center"
        >
